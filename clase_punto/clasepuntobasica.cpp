...
int main() {
    ...
    while (true) {
        system("cls");
        cout << "----------MENU------------" << endl;
        cout << "1. DIBUJAR UN PUNTO EN LA POSICION QUE EL USUARIO PIDA POR "
                "TECLADO"
             << endl;
        cout << "2. DIBUJAR UNA LINEA DE PUNTOS HORIZONTAL EN UNA POSICION DEL "
                "EJE "
                "Y DEFINIDA"
             << endl;
        cout << "3. DIBUJAR UNA LINEA DE PUNTOS VERTICAL EN UNA POSICION DEL "
                "EJE X "
                "DEFINIDA"
             << endl;
        cout
            << "4. DIBUJAR UNA LINEA DE PUNTOS HORIZONTAL QUE ALTERNE 2 COLORES"
            << endl;
        cout << "5. DIBUJAR UNA LINEA DE PUNTOS VERTICAL QUE ALTERNE 2 COLORES"
             << endl;
        cout << "6. DIBUJAR 2 LINEAS HORIZONTALES QUE NAZCAN EN AMBOS EXTREMOS "
                "DE "
                "LA PANTALLA "
             << endl;
        cout << " Y SE ENCUENTREN EN EL CENTRO DE LA PANTALLA. DEBEN SER DE "
                "DISTINTOS COLORES "
             << endl;
        cout << "7. DIBUJAR 2 LINEAS HORIZONTALES QUE NAZCAN EN AMBOS EXTREMOS "
                "DE "
                "LA PANTALLA "
             << endl;
        cout << " Y SE ENCUENTREN EN EL CENTRO DE LA PANTALLA. DEBEN SER DE "
                "DISTINTOS COLORES "
             << endl;
        cout << " AL ENCONTRARSE DEBEN LAS LINEAS DEBEN SUBIR HASTA LA "
                "POSICIÓN 0 "
                "DE Y "
             << endl;
        cout << "8. HACER UN PUNTO QUE PARPADEE EN LA PANTALLA EN UNA POSICION "
                "DADA"
             << endl;
        cout << "9. HACER UN RECTANGULO A PARTIR DE DOS VALORES DE 2 LADOS"
             << endl;
        cout << "10. HACER UN PUNTO QUE CAMINE POR LA PANTALLA DE MANERA "
                "HORIZONTAL"
             << endl;
        ...
        cout << "13. DIBUJAR UNA LLUVIA DE PUNTOS HASTA QUE SE PRESIONA UNA "
                "TECLA"
             << endl;
        cout << "OPCION: ";
        cin >> opc;
